...
const formTime = form.querySelector('#time');
...
function onSubmitForm(e) {
  ...
  if (isValidated) {
    sendRequest(formName.value, formPhone.value, formMessage.value, formEmail.value, formDate.value, formTime.value);
  } else {
...
function sendRequest(name, phone, message, email, date, time) {
  console.log(name, phone, message, email, date, time);
